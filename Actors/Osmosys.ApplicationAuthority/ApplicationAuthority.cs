...
namespace Osmosys.ApplicationAuthority
{
    /// <remarks>
    ...
    internal class ApplicationAuthority : Actor, IApplicationAuthority
    {
        ...
        public async Task AddCreateRoleAsync(string roleName)
        {
        ...
        public async Task RemoveDeleteUserAsync(UserDto user)
        {
            ...
            var userActorId = new ActorId(user.Path);
        ...
        public Task UpdateRoleAsync(RoleDto user)
        {
